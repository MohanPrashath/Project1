...
public class TinyDB {
    ...
    public ModelUser getUser() {
        ModelUser modelUser = (ModelUser) new Gson().fromJson(getString("app_data_user"), ModelUser.class);
        if (modelUser == null) {
            return null;
        }
        return modelUser;
    ...
    public void putUser(ModelUser modelUser) {
        checkForNullKey("app_data_user");
        putString("app_data_user", new Gson().toJson((Object) modelUser));
    }
